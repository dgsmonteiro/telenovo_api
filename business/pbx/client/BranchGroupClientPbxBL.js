/**
 * Classe -> PBX Client BranchGroupClientPbxBL
 ...
 * @constructor
 */
function BranchGroupClientPbxBL() {
 ...
 */
BranchGroupClientPbxBL.prototype.GetListBranchGroupByClientId = function ($client_id) {
 ...
 * @constructor
 */
BranchGroupClientPbxBL.prototype.UpdateBranchGroup = function ($client_id, $data, $user_logged) {
    var name = null;
 ...
 * @constructor
 */
BranchGroupClientPbxBL.prototype.RemoveBranchNumber = function ($client_id, $branch_number, $user_logged) {
 ...
 */
BranchGroupClientPbxBL.prototype.CreateNew = function ($client_id, $data) {
    var name = null;
    return promise.try(promiseGetClient)
        .then(promiseCreateBranch)
